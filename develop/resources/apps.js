...
handleMobileSidebarToggle = function() {
    ...
    function(a) {
        ...
        a.isPropagationStopped() || e === !0 || ($("#page-container").hasClass("page-sidebar-toggled") && (e = !0, $("#page-container").removeClass("page-sidebar-toggled")), $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (e = !0, $("#page-container").removeClass("page-right-sidebar-toggled")))
    }),
...
handleUnlimitedTabsRender = function() {
    ...
    function a(e, a) {
        ...
        case "prev":
            var l = -i;
            n >= l ? ($(t).removeClass("overflow-left"), s = 0) : s = l - n + 80,
...
handleUnlimitedTopMenuRender = function() {
    ...
    function e(e, a) {
        ...
        case "prev":
            var l = -i;
            n >= l ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), s = 0) : s = l - n + 88,
            $(t).animate({
                marginLeft: "-" + s + "px"
            },
            150,
    ...
    function a() {
        ...
        o != l && l >= n ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"),
        o >= n && l >= n ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
    }
