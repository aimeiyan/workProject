...
var handleSlimScroll = function () {
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function (a) {
        ...
        var a = $(this).closest("[data-scrollbar=true]"), t = $(window).height(), i = parseInt($("#sidebar").css("padding-top")), n = $("#sidebar").height();
        e = $(a).css("margin-top");
        var o = i;
        ...
        if (s >= o && o >= t && o >= n) {
            var l = t - o - 20;
            $(a).animate({marginTop: l + "px"})
        } else parseInt(e) >= 0 || n >= o ? $(a).animate({marginTop: "0px"}) : (l = e, $(a).animate({marginTop: l + "px"}))
    })
