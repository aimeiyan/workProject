...
var handleJstreeAjax = function () {
    ...
    $(".hr-tree-select,.hr-tree-select-down").click(function () {
        ...
        $("#jstree-ajax").jstree({
            ...
            //        url: function (e) {
            //            return "#" === e.id ? "data/data_root.json" : "data/" + e.original.file
            //        }, data: function (e) {
            //            return {id: e.id}
            //        }, dataType: "json"
            //    }
            ...
            plugins: ["dnd", "state", "types", "change"]
            //plugins: ["dnd", "state", "types", "change"]
        });
        ...
        $('#jstree-ajax').on("select_node.jstree", function (e, data) {
            ...
            var current_value = $(".hr-tree-select").val();

            if ($selected.hasClass('jstree-leaf')) {
                current_value = $selected.find("a").text();
            }

            var curr_value = data.instance.get_node(data.selected[0]);
